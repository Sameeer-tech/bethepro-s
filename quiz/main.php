...
<?php include '../assets/header.php'; ?>
  ...
  <!-- Quiz Banner -->
  <section class="quiz-banner animate-fade-in">
    <div class="container text-center">
      <h1 class="animate-slide-up">Test Your Skills</h1>
      <p class="animate-scale-in">Challenge yourself with our comprehensive interview preparation quizzes</p>
      <div class="quiz-stats animate-fade-in">
        <div class="quiz-stat">
          <span class="quiz-stat-number stats-number">6</span>
          <span class="quiz-stat-label">Categories</span>
        </div>
        <div class="quiz-stat">
          <span class="quiz-stat-number stats-number">180+</span>
          <span class="quiz-stat-label">Questions</span>
        </div>
        <div class="quiz-stat">
          <span class="quiz-stat-number stats-number">3</span>
